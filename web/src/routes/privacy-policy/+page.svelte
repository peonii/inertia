<div class="p-6">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Application</strong> refers to Inertia, the software program provided by the Company.
			</p>
		</li>
		<li>
			<p>
				<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
				or &quot;Our&quot; in this Agreement) refers to Inertia.
			</p>
		</li>
		<li>
	...
	<ul>
		<li>By email: querter.ovutem@gmail.com</li>
	</ul>
</div>
